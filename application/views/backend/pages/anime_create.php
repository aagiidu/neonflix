	...
	<div class="span12">
		<div class="grid simple ">
			...
			<div class="grid-body no-border">
				<form method="post" action="<?php echo base_url();?>index.php?admin/anime_create" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<a href="<?php echo base_url();?>index.php?admin/anime_list" class="btn btn-default">Буцах</a>
							</div>
						</div>
					</div>
				</form>
