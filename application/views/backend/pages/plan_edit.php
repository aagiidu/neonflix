					...
					<div class="row">
						<div class="col-md-8 col-sm-8 col-xs-8">
							...
							<div class="form-group">
								<label class="form-label">Багцын нэр</label>
							...
							<div class="form-group">
								...
								<div class="controls">
									<select class="select2" name="status" style="width:150px;">
										<option value="0" <?php if ( $plan_detail->status == 0) echo 'selected';?>>Идэвхигүй</option>
										<option value="1" <?php if ( $plan_detail->status == 1) echo 'selected';?>>Идэвхитэй</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								<input type="submit" class="btn btn-success" value="Хадгалах">
								<a href="<?php echo base_url();?>index.php?admin/plan_list" class="btn btn-default">Буцах</a>
							</div>
						</div>
					</div>
				</form>
