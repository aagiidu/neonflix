				...
				<ul class="nav quick-section ">
					<li class="quicklinks">
						...
						<ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
							<li>
								<a href="<?php echo base_url();?>index.php?admin/account"> Миний бүртгэл</a>
							</li>
							<li class="divider"></li>
							<li>
								<a href="<?php echo base_url();?>index.php?home/signout"><i class="material-icons">power_settings_new</i>&nbsp;&nbsp;Гарах</a>
							</li>
						</ul>
					</li>
				</ul>
