		...
		<div class="row">
			<form method="post" id="form" 
				...
				<div class="col-lg-8 col-lg-offset-2">
					...
					<hr style="border-top:1px solid #333;">
					<br>
					<a href="#" class="btn_block" onClick="submit_form()">Хадгалах</a>
					<a href="<?php echo base_url();?>index.php?browse/manageprofile" class="btn_blank">Болих</a>
				</div>
			</form>
		</div>
	</div>
