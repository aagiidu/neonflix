				...
				<div class="col-lg-7">
					<div class="row" style="margin: 5px;">
						<div class="pull-left black_text">
							<b><?php echo $this->crud_model->get_current_user_detail()->phone;?></b>
						</div>
						<div class="pull-right">
							<a href="<?php echo base_url();?>index.php?browse/phonechange" class="blue_text">Утасны дугаараа солих</a>
						</div>
					</div>
					<div class="row" style="margin: 5px;">
